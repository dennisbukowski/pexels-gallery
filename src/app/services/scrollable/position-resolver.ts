...
import { ContainerRef, IPositionElements, IPositionStats, IResolver } from '../../models/scrollable-models';
...
export function getDocumentElement(isContainerWindow: boolean, windowElement: any) {
