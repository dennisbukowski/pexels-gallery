import { IPositionStats, IScrollState, IScrollerDistance } from '../../models/scrollable-models';
...
export function shouldFireScrollEvent(
  ...
  if (scrollingDown) {
    ...
    containerBreakpoint = (distance.down ? distance.down : 0) / 10;
  } else {
    const totalHiddenContentHeight =
      container.scrolled + (container.totalToScroll - scrolledUntilNow);
    remaining = container.scrolled / totalHiddenContentHeight;
    containerBreakpoint = (distance.up ? distance.up : 0) / 10;
  }
